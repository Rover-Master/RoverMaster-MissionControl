...
<template>
    <svg class="controller-stick" viewBox="-90 -90 180 180" xmlns="http://www.w3.org/2000/svg">
        ...
        <text :x="x()" dy="4" :y="y()" dominant-baseline="middle" text-anchor="middle" v-if="text">{{ text }}</text>
    </svg>
</template>
